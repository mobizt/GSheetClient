...
namespace GSHEET
{
     ...
     */
    class PivotGroupValueMetadata : public BaseG4
    {
    ...
    public:
        ...
        PivotGroupValueMetadata &collapsed(bool value) { return wr.set<PivotGroupValueMetadata &, bool>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        PivotGroupSortValueBucket &buckets(const ExtendedValue &value) { return wr.append<PivotGroupSortValueBucket &, ExtendedValue>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        ManualRuleGroup &items(const ExtendedValue &value) { return wr.append<ManualRuleGroup &, ExtendedValue>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
     ...
     * +-------+-------------------+
     */
    class ManualRule : public BaseG1
    {
    ...
    public:
        ...
        HistogramRule &start(double value) { return wr.set<HistogramRule &, double>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
        ...
        HistogramRule &end(double value) { return wr.set<HistogramRule &, double>(*this, value, buf, bufSize, 3, FPSTR(__func__)); }
    };
    /**
    ...
    public:
        ...
        PivotGroupLimit &applyOrder(int value) { return wr.set<PivotGroupLimit &, int>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        PivotGroup &valueMetadata(const PivotGroupValueMetadata &value) { return wr.append<PivotGroup &, PivotGroupValueMetadata>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }

        // The order the values in this group should be sorted./
        PivotGroup &sortOrder(Sort::SortOrder value) { return wr.set<PivotGroup &, bool>(*this, _SortOrder[value].text, buf, bufSize, 3, FPSTR(__func__)); }

        // The bucket of the opposite pivot group to sort by. If not specified, sorting is alphabetical by this group's values.
        PivotGroup &valueBucket(const PivotGroupSortValueBucket &value) { return wr.set<PivotGroup &, PivotGroupSortValueBucket>(*this, value, buf, bufSize, 4, FPSTR(__func__)); }
        ...
        PivotGroup &repeatHeadings(bool value) { return wr.set<PivotGroup &, bool>(*this, value, buf, bufSize, 5, FPSTR(__func__)); }
        ...
        PivotGroup &lable(const String &value) { return wr.set<PivotGroup &, String>(*this, value, buf, bufSize, 6, FPSTR(__func__)); }

        // The group rule to apply to this row/column group.
        PivotGroup &groupRule(const PivotGroupRule &value) { return wr.set<PivotGroup &, PivotGroupRule>(*this, value, buf, bufSize, 7, FPSTR(__func__)); }

        // The count limit on rows or columns to apply to this pivot group.
        PivotGroup &groupLimit(const PivotGroupLimit &value) { return wr.set<PivotGroup &, PivotGroupLimit>(*this, value, buf, bufSize, 8, FPSTR(__func__)); }
        ...
        PivotGroup &sourceColumnOffset(int value) { return wr.set<PivotGroup &, int>(*this, value, buf, bufSize, 9, FPSTR(__func__)); }

        // Union field source
        // The reference to the data source column this grouping is based on.
        PivotGroup &dataSourceColumnReference(const DataSourceColumnReference &value) { return wr.set<PivotGroup &, DataSourceColumnReference>(*this, value, buf, bufSize, 9, FPSTR(__func__)); }
    };

    /**
     * Criteria for showing/hiding rows in a pivot table.
     */
    class PivotFilterCriteria : public BaseG4
    {
    ...
    public:
        ...
        PivotFilterCriteria &condition(const BooleanCondition &value) { return wr.set<PivotFilterCriteria &, BooleanCondition>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
        ...
        PivotFilterCriteria &visibleByDefault(bool value) { return wr.set<PivotFilterCriteria &, bool>(*this, value, buf, bufSize, 3, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        PivotFilterSpec &columnOffsetIndex(int value) { return wr.set<PivotFilterSpec &, int>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }

        // Union field source
        // The reference to the data source column.
        PivotFilterSpec &dataSourceColumnReference(const DataSourceColumnReference &value) { return wr.set<PivotFilterSpec &, DataSourceColumnReference>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        PivotValue &name(const String &value) { return wr.set<PivotValue &, String>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
        ...
        PivotValue &calculatedDisplayType(Display::PivotValueCalculatedDisplayType value) { return wr.set<PivotValue &, const char *>(*this, _PivotValueCalculatedDisplayType[value].text, buf, bufSize, 3, FPSTR(__func__)); }
        ...
        PivotValue &sourceColumnOffset(int value) { return wr.set<PivotValue &, int>(*this, value, buf, bufSize, 4, FPSTR(__func__)); }

        // Union field value
        // A custom formula to calculate the value. The formula must start with an = character.
        PivotValue &formula(const String &value) { return wr.set<PivotValue &, String>(*this, value, buf, bufSize, 4, FPSTR(__func__)); }

        // Union field value
        // The reference to the data source column that this value reads from.
        PivotValue &dataSourceColumnReference(const DataSourceColumnReference &value) { return wr.set<PivotValue &, DataSourceColumnReference>(*this, value, buf, bufSize, 4, FPSTR(__func__)); }
    };

    /**
     * A pivot table.
     */
    class PivotTable : public BaseG8
    {
    ...
    public:
        ...
        PivotTable &rows(const PivotGroup &value) { return wr.append<PivotTable &, PivotGroup>(*this, value, buf, bufSize, 1, FPSTR(__func__)); }

        // This value represents the item to add to an array.
        //  Each column grouping in the pivot table.
        PivotTable &columns(const PivotGroup &value) { return wr.append<PivotTable &, PivotGroup>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
        ...
        PivotTable &filterSpecs(const PivotFilterSpec &value) { return wr.append<PivotTable &, PivotFilterSpec>(*this, value, buf, bufSize, 3, FPSTR(__func__)); }

        // This value represents the item to add to an array.
        // A list of values to include in the pivot table.
        PivotTable &values(const PivotValue &value) { return wr.append<PivotTable &, PivotValue>(*this, value, buf, bufSize, 4, FPSTR(__func__)); }

        // Whether values should be listed horizontally (as columns) or vertically (as rows).
        PivotTable &valueLayout(Direction::PivotValueLayout value) { return wr.set<PivotTable &, const char *>(*this, _PivotValueLayout[value].text, buf, bufSize, 5, FPSTR(__func__)); }

        // Union field source_data
        // The range the pivot table is reading data from.
        PivotTable &source(const GridRange &value) { return wr.set<PivotTable &, GridRange>(*this, value, buf, bufSize, 6, FPSTR(__func__)); }

        // Union field source_data
        // The ID of the data source the pivot table is reading data from.
        PivotTable &dataSourceId(const String &value) { return wr.set<PivotTable &, String>(*this, value, buf, bufSize, 6, FPSTR(__func__)); }
    };
