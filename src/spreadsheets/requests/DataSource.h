...
namespace GSHEET
{
    ...
    public:
        ...
        DataSourceParameter &namedRangeId(const String &value) { return wr.set<DataSourceParameter &, String>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }

        // Union field value
        // A range that contains the value of the parameter. Its size must be 1x1.
        DataSourceParameter &range(const GridRange &value) { return wr.set<DataSourceParameter &, GridRange>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        Interval &startTime(const String &value) { return wr.set<Interval &, String>(*this, value, buf, bufSize, 1, FPSTR(__func__)); }

        // Optional. Exclusive end of the interval.
        // If specified, a Timestamp matching this interval will have to be before the end.
        Interval &endTime(const String &value) { return wr.set<Interval &, String>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        BigQueryTableSpec &tableId(const String &value) { return wr.set<BigQueryTableSpec &, String>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }

        // The BigQuery dataset id.
        BigQueryTableSpec &datasetId(const String &value) { return wr.set<BigQueryTableSpec &, String>(*this, value, buf, bufSize, 3, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        // Union field spec
        // A BigQueryQuerySpec.
        BigQueryDataSourceSpec &querySpec(const BigQueryQuerySpec &value) { return wr.set<BigQueryDataSourceSpec &, BigQueryQuerySpec>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }

        // Union field spec
        // A BigQueryTableSpec.
        BigQueryDataSourceSpec &tableSpec(const BigQueryTableSpec &value) { return wr.set<BigQueryDataSourceSpec &, BigQueryTableSpec>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        DataSourceSpec &parameters(const DataSourceParameter &value) { return wr.append<DataSourceSpec &, DataSourceParameter>(*this, value, buf, bufSize, 1, FPSTR(__func__)); }

        // A BigQueryDataSourceSpec.
        DataSourceSpec &bigQuery(const BigQueryDataSourceSpec &value) { return wr.set<DataSourceSpec &, BigQueryDataSourceSpec>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
     ...
     */
    class DataSourceColumn : public BaseG4
    {
    ...
    public:
        ...
        DataSourceColumn &formula(const String &value) { return wr.set<DataSourceColumn &, String>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }
    };
    ...
    public:
        ...
        DataSource &spec(const DataSourceSpec &value) { return wr.set<DataSource &, DataSourceSpec>(*this, value, buf, bufSize, 2, FPSTR(__func__)); }

        // This value represents the item to add to an array.
        // All calculated columns in the data source.
        DataSource &calculatedColumns(const DataSourceColumn &value) { return wr.append<DataSource &, DataSourceColumn>(*this, value, buf, bufSize, 3, FPSTR(__func__)); }
        ...
        DataSource &sheetId(int value) { return wr.set<DataSource &, int>(*this, value, buf, bufSize, 4, FPSTR(__func__)); }
    };
